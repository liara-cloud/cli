...
running command...
$ liara (--version|-v)
@liara/cli/9.3.2 linux-x64 node-v22.13.1
$ liara --help [COMMAND]
USAGE
  $ liara COMMAND
...
...
_See code: [src/commands/init.ts](https://github.com/liara-ir/liara-cli/blob/v9.3.2/src/commands/init.ts)_
...
_See code: [src/commands/vm/create.ts](https://github.com/liara-ir/liara-cli/blob/v9.3.2/src/commands/vm/create.ts)_
...
_See code: [src/commands/vm/delete.ts](https://github.com/liara-ir/liara-cli/blob/v9.3.2/src/commands/vm/delete.ts)_
...
_See code: [src/commands/vm/info.ts](https://github.com/liara-ir/liara-cli/blob/v9.3.2/src/commands/vm/info.ts)_
...
_See code: [src/commands/vm/list.ts](https://github.com/liara-ir/liara-cli/blob/v9.3.2/src/commands/vm/list.ts)_
...
_See code: [src/commands/vm/restart.ts](https://github.com/liara-ir/liara-cli/blob/v9.3.2/src/commands/vm/restart.ts)_
...
_See code: [src/commands/vm/start.ts](https://github.com/liara-ir/liara-cli/blob/v9.3.2/src/commands/vm/start.ts)_
...
_See code: [src/commands/vm/stop.ts](https://github.com/liara-ir/liara-cli/blob/v9.3.2/src/commands/vm/stop.ts)_
