...
running command...
$ liara (--version|-v)
@liara/cli/5.4.0-beta.2 linux-x64 node-v18.17.1
$ liara --help [COMMAND]
USAGE
  $ liara COMMAND
...
...
_See code: [src/commands/deploy.ts](https://github.com/liara-ir/liara-cli/blob/v5.4.0-beta.2/src/commands/deploy.ts)_
...
_See code: [src/commands/login.ts](https://github.com/liara-ir/liara-cli/blob/v5.4.0-beta.2/src/commands/login.ts)_
