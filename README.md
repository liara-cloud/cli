...
running command...
$ liara (--version|-v)
@liara/cli/3.0.0 linux-x64 node-v16.17.0
$ liara --help [COMMAND]
USAGE
  $ liara COMMAND
...
...
_See code: [src/commands/deploy.ts](https://github.com/liara-ir/liara-cli/blob/v3.0.0/src/commands/deploy.ts)_
...
_See code: [src/commands/login.ts](https://github.com/liara-ir/liara-cli/blob/v3.0.0/src/commands/login.ts)_
